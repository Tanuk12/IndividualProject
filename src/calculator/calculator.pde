...
Cuboid c1;
   ...
   void draw(String[] args) {
    ...
    boolean loop = true;
    while(loop) {
    System.out.println("please select which shape you would like to do 1 is cube, 2 is pyramid, 3 is sphere, 4 is cone, 5 is cylinder, and once you are done press 6");
    ...
    case 1:
      ...
      int height = scan.nextInt();
         c1 = new Cuboid(length,width,height);
